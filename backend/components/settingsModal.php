...
<div class="settings" id="modal">
  <div class="settings__content" id="modalContent">
    <button style="background-color:none;" class="settings__closeBtn" id="closeModalBtn" tabindex="0">
    ...
    <div class="settings__item">
      ...
      <label class="settings__switch">
        <input id="darkmodeCheckbox" tabindex="0" type="checkbox" aria-label="Switch dark mode button"         
        <?php 
