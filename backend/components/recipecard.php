...
<div class="recipe" data-id="recipe<?= $recipeId ?>">
  ...
  <div class="recipe__bottom">
    ...
    <div class="recipe__info">
      ...
      <a href="/details.php?recipe=<?= $recipeId ?>" name="recipe" value="<?= $recipeId ?>" class="recipe__detailsBtn" aria-label="search"><?= $lang['details'] ?><i class="fas fa-chevron-right"></i></a></a>
    </div>
  </div>
</div>
