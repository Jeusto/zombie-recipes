...
<div class="recipe" data-id="recipe<?= $recipeId ?>">
  <div class="recipe__top">
    <img src="images/recipes/<?= $recipeImageUrl ?>" alt="<?= $recipeName ?> recipe image" class="recipe__image" />
    <button id="bookmarkBtn<?= $recipeId ?>" class="recipe__bookmarkBtn <?= $recipeIconName ?>" aria-label="Bookmark button"></button>
  </div>
  <div class="recipe__bottom">
    ...
    <div class="recipe__info">
      ...
      <a href="/details.php?recipe=<?= $recipeId ?>" class="recipe__detailsBtn" aria-label="search"><?= $lang['details'] ?><i class="fas fa-chevron-right"></i></a>
    </div>
  </div>
</div>
